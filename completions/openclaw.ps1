...
Register-ArgumentCompleter -Native -CommandName openclaw -ScriptBlock {
    ...
    for ($i = 1; $i -lt $commandElements.Count; $i++) {
        ...
        switch ($candidatePath) {
            ...
            'database preflight-agent' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--agent-id')
            }
            'database ownership' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level')
            ...
            'migrate plan' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--backup-output','--from','--agent','--skill','--plugin','--item')
            }
            'migrate apply' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--from','--agent','--skill','--plugin','--item','--backup-output')
            ...
            'message search' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--channel','--account','--query','--guild-id','--channel-id','--channel-ids','--author-id','--author-ids','--limit')
            }
            'message thread' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level')
            ...
            'message member info' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--user-id','--channel','--account','--guild-id','--channel-id')
            }
            'message voice' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level')
            ...
            'agent exec' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','-m','--message','-t','--to','--session-key','--session-id','--agent','--verbose','--channel','--reply-to','--reply-channel','--reply-account','--message-file','--cwd','--state-dir','--config','--model','--code-mode','--thinking','--fallback','--timeout')
            }
            'agents' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level')
            ...
            'agents add' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--workspace','--role','--model','--agent-dir','--bind')
            }
            'agents team' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level')
            ...
            'agents team create' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--preset','--coordinator','--prefix','--workspace-root')
            }
            'agents set-identity' {
                $commandPath = $candidatePath
            ...
            'sessions cleanup' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--active','--limit','--store','--agent','--active-key')
            }
            'sessions tail' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--active','--limit','--session-key','--tail','--store','--agent')
            }
            'sessions export-trajectory' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--active','--limit','--session-key','--output','--workspace','--store','--agent','--request-json-base64')
            }
            'sessions archive' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--store','--active','--limit','--agent','--url','--token','--password','--timeout')
            }
            'sessions delete' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--store','--active','--limit','--agent','--url','--token','--password','--timeout')
            ...
            'gateway' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--port','--bind','--token','--auth','--password','--password-file','--tailscale','--task-supervisor-child','--ws-log','--raw-stream-path')
            }
            'gateway run' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--port','--bind','--token','--auth','--password','--password-file','--tailscale','--task-supervisor-child','--ws-log','--raw-stream-path')
            ...
            'gateway status' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--bind','--auth','--password-file','--tailscale','--task-supervisor-child','--ws-log','--raw-stream-path','--url','--port','--token','--password','--timeout')
            }
            'gateway install' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--bind','--auth','--password','--password-file','--tailscale','--task-supervisor-child','--ws-log','--raw-stream-path','--port','--runtime','--runtime-path','--token','--wrapper','--update-executor')
            }
            'gateway uninstall' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--port','--bind','--token','--auth','--password','--password-file','--tailscale','--task-supervisor-child','--ws-log','--raw-stream-path')
            ...
            'gateway stop' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--port','--bind','--token','--auth','--password','--password-file','--tailscale','--task-supervisor-child','--ws-log','--raw-stream-path','--update-executor')
            }
            'gateway restart' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--port','--bind','--token','--auth','--password','--password-file','--tailscale','--task-supervisor-child','--ws-log','--raw-stream-path','--update-executor','--wait')
            }
            ...
            'gateway restart-handoff consume' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--port','--bind','--token','--auth','--password','--password-file','--tailscale','--task-supervisor-child','--ws-log','--raw-stream-path','--expected-pid')
            }
            'gateway auth-token' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--port','--bind','--token','--auth','--password','--password-file','--tailscale','--task-supervisor-child','--ws-log','--raw-stream-path')
            ...
            'gateway call' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--bind','--auth','--password-file','--tailscale','--task-supervisor-child','--ws-log','--raw-stream-path','--expect-url','--params','--url','--port','--token','--password','--timeout')
            }
            'gateway suspend' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--bind','--auth','--password-file','--tailscale','--task-supervisor-child','--ws-log','--raw-stream-path','--request-id','--wait','--url','--port','--token','--password','--timeout')
            }
            'gateway resume' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--bind','--auth','--password-file','--tailscale','--task-supervisor-child','--ws-log','--raw-stream-path','--url','--port','--token','--password','--timeout')
            ...
            'gateway usage-cost' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--bind','--auth','--password-file','--tailscale','--task-supervisor-child','--ws-log','--raw-stream-path','--days','--agent','--url','--port','--token','--password','--timeout')
            }
            'gateway health' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--bind','--auth','--password-file','--tailscale','--task-supervisor-child','--ws-log','--raw-stream-path','--url','--port','--token','--password','--timeout')
            ...
            'gateway stability' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--bind','--auth','--password-file','--tailscale','--task-supervisor-child','--ws-log','--raw-stream-path','--limit','--type','--since-seq','--bundle','--output','--url','--port','--token','--password','--timeout')
            }
            'gateway diagnostics' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--port','--bind','--token','--auth','--password','--password-file','--tailscale','--task-supervisor-child','--ws-log','--raw-stream-path')
            ...
            'gateway diagnostics export' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--port','--bind','--auth','--password-file','--tailscale','--task-supervisor-child','--ws-log','--raw-stream-path','--output','--log-lines','--log-bytes','--url','--token','--password','--timeout')
            }
            'gateway probe' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--bind','--auth','--password-file','--tailscale','--task-supervisor-child','--ws-log','--raw-stream-path','--url','--port','--ssh','--ssh-identity','--token','--password','--timeout')
            }
            'gateway discover' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--port','--bind','--token','--auth','--password','--password-file','--tailscale','--task-supervisor-child','--ws-log','--raw-stream-path','--timeout')
            }
            'daemon' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level')
            ...
            'daemon install' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--port','--runtime','--runtime-path','--token','--wrapper','--update-executor')
            }
            'daemon uninstall' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level')
            ...
            'daemon stop' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--update-executor')
            }
            'daemon restart' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--update-executor','--wait')
            }
            'logs' {
                $commandPath = $candidatePath
            ...
            'models list' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--provider','--agent')
            }
            'models status' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--probe-provider','--probe-profile','--probe-timeout','--probe-concurrency','--probe-max-tokens','--agent')
            }
            'models refresh' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--agent')
            ...
            'infer model run' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--prompt','--file','--model','--thinking','--agent')
            }
            ...
            'infer model auth login' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--provider','--method','--agent')
            }
            ...
            'infer image generate' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--prompt','--model','--count','--size','--aspect-ratio','--resolution','--output-format','--background','--openai-background','--openai-moderation','--quality','--timeout-ms','--output','--agent')
            }
            ...
            'infer image edit' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--file','--prompt','--model','--count','--size','--aspect-ratio','--resolution','--output-format','--background','--openai-background','--openai-moderation','--quality','--timeout-ms','--output','--agent')
            }
            ...
            'infer image describe' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--file','--prompt','--model','--timeout-ms','--agent')
            }
            ...
            'infer audio transcribe' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--file','--agent','--language','--prompt','--model')
            }
            ...
            'infer video generate' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--prompt','--model','--size','--aspect-ratio','--resolution','--duration','--timeout-ms','--output','--agent')
            }
            ...
            'infer video describe' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--file','--agent','--model')
            }
            ...
            'infer embedding create' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--text','--provider','--model','--agent')
            }
            ...
            'node' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--commands')
            }
            'node worker' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--commands')
            ...
            'node install' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--commands','--host','--port','--context-path','--tls-fingerprint','--node-id','--display-name','--runtime','--runtime-path')
            }
            'node uninstall' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--commands')
            ...
            'connect' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--commands','--target-file','--display-name')
            }
            'worker' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level')
            ...
            'worktrees create' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--name','--base-ref','--source-profile')
            }
            'worktrees remove' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level')
            ...
            'cron runs' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--id','--run-id','--status','--delivery-status','--query','--offset','--sort','--limit','--url','--port','--token','--password','--timeout')
            }
            'automations runs' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--id','--run-id','--status','--delivery-status','--query','--offset','--sort','--limit','--url','--port','--token','--password','--timeout')
            ...
            'cron run' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--wait-timeout','--poll-interval','--url','--port','--token','--password','--timeout')
            }
            'automations run' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--wait-timeout','--poll-interval','--url','--port','--token','--password','--timeout')
            ...
            'cron scratch' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--set','--file','--expected-revision','--url','--port','--token','--password','--timeout')
            }
            'automations scratch' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--set','--file','--expected-revision','--url','--port','--token','--password','--timeout')
            ...
            'channels resolve' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--channel','--account','--agent','--kind')
            }
            'channels logs' {
                $commandPath = $candidatePath
            ...
            'channels dead-letters list' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--agent','--channel','--account','--limit')
            }
            ...
            'skills install' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--version','--agent','--as')
            }
            'skills update' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--agent')
            ...
            'skills verify' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--version','--tag','--agent')
            }
            'skills curator' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--agent')
            ...
            'skills workshop propose-create' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--name','--description','--proposal','--proposal-dir','--goal','--evidence','--agent')
            }
            'skills workshop propose-update' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--proposal','--proposal-dir','--description','--goal','--evidence','--agent')
            }
            ...
            'skills workshop evaluate' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--correlation-id','--agent')
            }
            ...
            'skills workshop reject' {
                $commandPath = $candidatePath
                $valueOptions = @('--container','--profile','--log-level','--reason','--agent')
            }
    ...
    if ($commandPath -eq 'gateway install') {
        if ($choiceFlag -in @('--update-executor')) {
            $matchingChoices = @(@('check','run') | Where-Object {
                $_.StartsWith($choicePrefix, [StringComparison]::OrdinalIgnoreCase)
            })
            $matchingChoices | ForEach-Object {
                $choiceValue = if ($_ -match '^[A-Za-z0-9_./:+-]+$') {
    ...
    if ($commandPath -eq 'cron runs') {
        if ($choiceFlag -in @('--status')) {
            $matchingChoices = @(@('all','ok','error','skipped') | Where-Object {
                $_.StartsWith($choicePrefix, [StringComparison]::OrdinalIgnoreCase)
            })
            $matchingChoices | ForEach-Object {
                $choiceValue = if ($_ -match '^[A-Za-z0-9_./:+-]+$') {
        ...
        if ($choiceFlag -in @('--delivery-status')) {
            $matchingChoices = @(@('delivered','not-delivered','unknown','not-requested') | Where-Object {
                $_.StartsWith($choicePrefix, [StringComparison]::OrdinalIgnoreCase)
            })
            $matchingChoices | ForEach-Object {
                $choiceValue = if ($_ -match '^[A-Za-z0-9_./:+-]+$') {
        ...
        if ($choiceFlag -in @('--sort')) {
            $matchingChoices = @(@('asc','desc') | Where-Object {
                $_.StartsWith($choicePrefix, [StringComparison]::OrdinalIgnoreCase)
            })
            $matchingChoices | ForEach-Object {
                $choiceValue = if ($_ -match '^[A-Za-z0-9_./:+-]+$') {
    ...
    if ($commandPath -eq "") {
         ...
         $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
            ...
            if ($commandPath -eq 'onboard recommendations') {
                $completions = @('acknowledge','refresh','--agent','--json')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }
            ...
            if ($commandPath -eq 'onboard recommendations acknowledge') {
                $completions = @('--agent','--retry')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }

            if ($commandPath -eq 'onboard recommendations refresh') {
                $completions = @('--agent')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            ...
            if ($commandPath -eq 'database') {
                $completions = @('ownership','preflight','preflight-agent')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }
            ...
            if ($commandPath -eq 'database preflight-agent') {
                $completions = @('--agent-id','--json')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }
            ...
            if ($commandPath -eq 'message search') {
                $completions = @('--channel','--account','--json','--dry-run','--verbose','--query','--guild-id','--channel-id','--channel-ids','--author-id','--author-ids','--limit')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }
            ...
            if ($commandPath -eq 'message member info') {
                $completions = @('--user-id','--channel','--account','--json','--dry-run','--verbose','--guild-id','--channel-id')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }
            ...
            if ($commandPath -eq 'agents') {
                $completions = @('add','bind','bindings','delete','list','set-identity','team','unbind')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }
            ...
            if ($commandPath -eq 'agents add') {
                $completions = @('--workspace','--role','--model','--agent-dir','--bind','--non-interactive','--json')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }

            if ($commandPath -eq 'agents team') {
                $completions = @('create')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            ...
            if ($commandPath -eq 'agents team create') {
                $completions = @('--preset','--coordinator','--prefix','--workspace-root','--non-interactive','--json')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }
            ...
            if ($commandPath -eq 'gateway install') {
                $completions = @('--port','--runtime','--runtime-path','--token','--wrapper','--allow-unconfigured','--force','--json')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }
            ...
            if ($commandPath -eq 'gateway call') {
                $completions = @('--expect-url','--params','--url','--port','--token','--password','--timeout','--expect-final','--json')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }
            ...
            if ($commandPath -eq 'models list') {
                $completions = @('--refresh','--all','--local','--provider','--agent','--json','--plain')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }
            ...
            if ($commandPath -eq 'models auth') {
                $completions = @('activate','add','list','login','login-github-copilot','logout','order','paste-api-key','paste-token','setup-token','--agent')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }
            ...
            if ($commandPath -eq 'models auth activate') {
                $completions = @('--agent')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            ...
            if ($commandPath -eq 'devices rotate') {
                $completions = @('--device','--role','--scope','--no-scopes','--url','--token','--password','--timeout','--json')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }
            ...
            if ($commandPath -eq 'node') {
                $completions = @('identity','install','restart','run','start','status','stop','uninstall','--commands','--all-commands')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }
            ...
            if ($commandPath -eq 'node install') {
                $completions = @('--commands','--all-commands','--host','--port','--context-path','--tls','--no-tls','--tls-fingerprint','--node-id','--display-name','--share-installed-apps','--no-share-installed-apps','--runtime','--runtime-path','--force','--json')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }
            ...
            if ($commandPath -eq 'connect') {
                $completions = @('--commands','--all-commands','--service','--ephemeral','--session-host','--target-file','--display-name')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }
            ...
            if ($commandPath -eq 'fleet logs') {
                $completions = @('--follow','--timestamps','--tail','--since')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }
            ...
            if ($commandPath -eq 'worktrees create') {
                $completions = @('--name','--base-ref','--source-profile','--json')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }
            ...
            if ($commandPath -eq 'cron runs') {
                $completions = @('--json','--id','--run-id','--status','--delivery-status','--query','--offset','--sort','--limit','--url','--port','--token','--password','--timeout','--expect-final')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }
            ...
            if ($commandPath -eq 'plugins') {
                $completions = @('build','disable','doctor','enable','init','inspect','info','install','list','marketplace','pack','registry','reload','search','uninstall','update','validate')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }
            ...
            if ($commandPath -eq 'update migration-plan') {
                $completions = @('--snapshot-home','--snapshot-config','--snapshot-state','--dry-run','--json')
                $completions | Where-Object { $_ -like "$wordToComplete*" } | ForEach-Object {
                    [System.Management.Automation.CompletionResult]::new($_, $_, 'ParameterName', $_)
                }
            }
