...
Issues and specs live in GitHub Issues for `henningsieh/openclaw-setup`; use the `gh` CLI. See `docs/agents/issue-tracker.md`.
...
This is a single-context repository using `CONTEXT.md` and `docs/adr/`; read `AGENTS.md` first for authoritative instance context. See `docs/agents/domain.md`.
