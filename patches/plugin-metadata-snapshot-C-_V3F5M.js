...
function resolvePersistedRegistryMemoStateForLookup(params, memo) {
	...
	if (registryState && registryState.contextHash === contextHash && registryState.fastHash === fastHash) { const _now = Date.now(); if ((_now - _watchedFilesTtlAt) < 2000 || hashWatchedFiles(registryState.watchedFiles) === registryState.watchedFilesHash) { _watchedFilesTtlAt = _now; return registryState; } }
